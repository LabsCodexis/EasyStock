...
<body>
<div class="modal fade" id="editProdutoModal" tabindex="-1" aria-labelledby="editProdutoLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden"><!-- Modal Header -->
            ...
            <div class="modal-body p-4 p-md-5" style="background: #f8fafc;">
                <form id="editProdutoForm">
                    ...
                    <div class="row g-4 mb-4">
                        {{--                        <div class="col-md-6"><label for="edit-produto-quantidade"--}}
                        {{--                                                     class="form-label d-flex align-items-center gap-2 fw-semibold text-muted mb-2">--}}
                        {{--                                <i class="bi bi-stack text-warning"></i> Quantidade em Estoque </label>--}}
                        {{--                            <div class="input-group input-group-lg">--}}
                        {{--                                <button class="btn btn-outline-secondary rounded-start-3" type="button"--}}
                        {{--                                        onclick="changeModalQuantity(-1)"><i class="bi bi-dash"></i></button>--}}
                        ...
                        {{--                                        onclick="changeModalQuantity(1)"><i class="bi bi-plus"></i></button>--}}
                        {{--                            </div>--}}
                        {{--                        </div>--}}

                        <div class="col-md-6">
                            <label for="edit-produto-gramatura"
                                   class="form-label d-flex align-items-center gap-2 fw-semibold text-muted mb-2">
                                <i class="bi bi-speedometer2 text-info"></i>
                                Gramatura
                            </label>
                            <input type="text" class="form-control form-control-lg rounded-3 border-2" id="edit-produto-gramatura"
                                   name="gramatura"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="number" class="form-control fw-bold border-2 rounded-end-3"
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-3 pt-4 border-top">
                        <button type="button" class="btn btn-lg btn-light border-2 rounded-3 flex-fill"
                                data-bs-dismiss="modal"><i class="bi bi-x-circle me-2"></i> Cancelar
                        </button>
                        <button type="submit" class="btn btn-lg btn-success shadow-sm rounded-3 flex-fill"><i
                                class="bi bi-check-circle me-2"></i> Salvar Alterações
                        </button>
                    </div>
                </form>
            </div>
